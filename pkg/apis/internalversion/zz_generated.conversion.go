...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*ManagesSelector)(nil), (*operatorv1alpha1.ManagesSelector)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_internalversion_ManagesSelector_To_v1alpha1_ManagesSelector(a.(*ManagesSelector), b.(*operatorv1alpha1.ManagesSelector), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*operatorv1alpha1.ManagesSelector)(nil), (*ManagesSelector)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_ManagesSelector_To_internalversion_ManagesSelector(a.(*operatorv1alpha1.ManagesSelector), b.(*ManagesSelector), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_internalversion_ControllerSpec_To_v1alpha1_ControllerSpec(in *ControllerSpec, out *operatorv1alpha1.ControllerSpec, s conversion.Scope) error {
	out.Manages = *(*[]operatorv1alpha1.ManagesSelector)(unsafe.Pointer(&in.Manages))
	return nil
}
...
func autoConvert_v1alpha1_ControllerSpec_To_internalversion_ControllerSpec(in *operatorv1alpha1.ControllerSpec, out *ControllerSpec, s conversion.Scope) error {
	out.Manages = *(*[]ManagesSelector)(unsafe.Pointer(&in.Manages))
	return nil
}
...
func autoConvert_internalversion_KwokctlConfigurationOptions_To_v1alpha1_KwokctlConfigurationOptions(in *KwokctlConfigurationOptions, out *configv1alpha1.KwokctlConfigurationOptions, s conversion.Scope) error {
	...
	out.KubeApiserverInsecurePort = in.KubeApiserverInsecurePort
	out.InsecureKubeconfig = in.InsecureKubeconfig
...
func autoConvert_internalversion_ManagesSelector_To_v1alpha1_ManagesSelector(in *ManagesSelector, out *operatorv1alpha1.ManagesSelector, s conversion.Scope) error {
	out.Kind = in.Kind
	out.Group = in.Group
	out.Version = in.Version
...
func Convert_internalversion_ManagesSelector_To_v1alpha1_ManagesSelector(in *ManagesSelector, out *operatorv1alpha1.ManagesSelector, s conversion.Scope) error {
	return autoConvert_internalversion_ManagesSelector_To_v1alpha1_ManagesSelector(in, out, s)
}

func autoConvert_v1alpha1_ManagesSelector_To_internalversion_ManagesSelector(in *operatorv1alpha1.ManagesSelector, out *ManagesSelector, s conversion.Scope) error {
	out.Kind = in.Kind
	out.Group = in.Group
	out.Version = in.Version
	out.Namespace = in.Namespace
...
func Convert_v1alpha1_ManagesSelector_To_internalversion_ManagesSelector(in *operatorv1alpha1.ManagesSelector, out *ManagesSelector, s conversion.Scope) error {
